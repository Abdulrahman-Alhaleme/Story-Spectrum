  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800 shadow-2xl z-[50] ">
          <ul className="space-y-2 font-medium">
            <li>
              <button
                onClick={() => navigate("/")}
                className="flex items-center w-full gap-1 p-2 text-white transition duration-75 rounded-lg  group hover:bg-white hover:text-black pl-2   text-[18px]"
              >
                <AiFillHome />
                Home
              </button>
            ...
            <li>
              <button
                onClick={handleClick}
                id="All"
                className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-5 group hover:bg-white hover:text-black"
              >
                All
              </button>
            </li>
