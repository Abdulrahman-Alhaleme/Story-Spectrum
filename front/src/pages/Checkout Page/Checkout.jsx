      ...
      <div className="relative mx-auto my-12 w-full max-w-7xl bg-white">
        <div className="grid grid-cols-10">
          ...
          <div className="col-span-full lg:col-span-4 relative py-6 sm:py-12 lg:py-24 pl-8 pr-4 flex flex-col">
            ...
            <div>
              <img
                src="https://i.pinimg.com/originals/cf/23/d0/cf23d0a89768f3513fda19fbcbff7eb2.jpg"
                alt="img"
                className="absolute inset-0 w-full h-full"
              />
              <div className="absolute inset-0 w-full h-full bg-gradient-to-t from-[#9f9c9c] to-[#000000] opacity-75" />
            </div>
            ...
            <div className="relative mt-10 text-white">
              ...
              <p className="text-sm font-semibold">+962 788888888 </p>
              <p className="mt-1 text-sm font-semibold">
                +962 799999999 <span className=" font-bold">(Jordan)</span>
              </p>
