...
export const Services = () => {
  return (
    <>
      <section className="bg-gray-500  dark:bg-gray-900" id="services">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div className="bg-white transition hover:translate-x-2 hover:shadow-2xl rounded-lg p-3 shadow-xl hover:border-l-2 hover:border-primary">
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-white text-black text-2xl lg:h-12 lg:w-12 dark:bg-primary-900 border-2 border-black">
                <BiBookOpen />
              </div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Gain access to an extensive collection of digital Manga spanning
                action, comedy, slice of life, horro, and more.
              </p>
            </div>
            <div className="bg-white transition hover:translate-x-2 hover:shadow-2xl rounded-lg p-3 shadow-xl hover:border-l-2 hover:border-primary">
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-white text-black text-2xl lg:h-12 lg:w-12 dark:bg-primary-900 border-2 border-black">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                specific Manga by title, genre, or keywords.
              </p>
            </div>
            <div className="bg-white transition hover:translate-x-2 hover:shadow-2xl rounded-lg p-3 shadow-xl hover:border-l-2 hover:border-primary">
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-white text-black text-2xl lg:h-12 lg:w-12 dark:bg-primary-900 border-2 border-black">
            ...
            <div className="bg-white transition hover:translate-x-2 hover:shadow-2xl rounded-lg p-3 shadow-xl hover:border-l-2 hover:border-primary">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                and recommended Manga to stay up to date with your reading
                choices.
              </p>
            </div>
            <div className="bg-white transition hover:translate-x-2 hover:shadow-2xl rounded-lg p-3 shadow-xl hover:border-l-2 hover:border-primary">
