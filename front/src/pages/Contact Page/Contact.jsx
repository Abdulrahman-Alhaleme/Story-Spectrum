...
export const Contact = () => {
  return (
    <>
      <NavbarLanding />
      <section className="bg-[#ffffff6e] flex justify-center items-center dark:bg-gray-900 h-[110vh] login-page-bg">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md bg-[#ffffff84] rounded-lg shadow-md md:mb-5 md:mt-5">
          <h2 className="mb-4 text-4xl tracking-tight text-center text-black dark:text-white">
            Contact Us
          </h2>
